...
package org.archmage.cc.crawl.driver.historyTrade.mock;
...
public class MockSinaHistoryTradeCrawlDriver extends SinaHistoryTradeCrawlDriver {
    ...
    public int obtainTodoRequest() throws CrawlErrorException {
        ...
        sinaHistoryTradeRequestObject.setYear(2015);
        sinaHistoryTradeRequestObject.setMonth(5);
        sinaHistoryTradeRequestObject.setDay(28);
